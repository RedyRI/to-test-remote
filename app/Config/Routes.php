...
$routes->add('/radios', 'Radios::index');
$routes->add('/get_program/(:any)', 'Radios::ajax_get_program_onda_pana/$1');
$routes->add('/radios/get_program/onda-cero', 'Radios::ajax_get_program_onda');
$routes->add('/radios/get_program/panamericana', 'Radios::ajax_get_program_pana');
